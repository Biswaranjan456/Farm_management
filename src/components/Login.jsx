...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex flex-col justify-center items-center p-3 sm:p-4">
      <div className="bg-white p-5 sm:p-8 rounded-2xl shadow-xl w-full max-w-md border-t-4 border-green-600">
        <div className="flex flex-col items-center mb-2 sm:mb-4 -mt-4 sm:-mt-6 md:-mt-10 lg:-mt-12">
          ...
          <p className="-mt-6 sm:-mt-10 md:-mt-14 lg:-mt-16 text-green-800 font-serif italic text-[11px] sm:text-sm md:text-base lg:text-lg font-bold text-center tracking-widest z-20 relative">{t('common.appTagline', 'Every Farmer\'s Digital Companion')}</p>
        </div>
